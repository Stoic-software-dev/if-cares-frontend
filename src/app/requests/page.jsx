...
export default function RequestsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto flex max-w-md flex-col gap-6 px-4 pb-8 pt-5 md:max-w-3xl md:px-8 md:pt-7">
        ...
        <form onSubmit={submit} className="flex flex-col gap-4 rounded-[14px] border border-slate-200 bg-white p-4 md:p-5">
          ...
          <Button type="submit" className="h-12 rounded-[10px] text-sm font-semibold md:w-56 md:self-end">
            ...
            {requests.map((request, index) => (
              ...
              >
                <div className="flex min-w-0 flex-1 flex-col">
                  ...
                  <span className="text-xs text-slate-400">{request.detail} · {request.date}</span>
                </div>
